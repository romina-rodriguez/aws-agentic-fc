...
3. If hasBall=True AND distOppGoal >= 45 → MOVE_TO toward opponent goal (advance x by 15), sprint=true
4. If teammate has ball AND ball is in our half → MOVE_TO x=opp_goal*0.4, y=0, sprint=true
5. If teammate has ball AND ball is in opponent half → MOVE_TO x=opp_goal*0.65, y=0, sprint=false
...
8. Otherwise → MOVE_TO x=opp_goal*0.35, y=0, sprint=false
